...
proc main() =
  ...
  var model = loadModel("resources/glTF-Sample-Assets/Models/IridescentDishWithOlives/glTF/IridescentDishWithOlives.gltf")
  #var model = loadModel("resources/Olives.obj")
  #var materials = loadMaterials("resources/Olives.mtl")
  ...
  var camera = Camera3D(
    position : Vector3( x:0.5f, y:0.5f, z:15.0f ),
  ...
  while not windowShouldClose(): # Detect window close button or ESC key
    ...
    # drawMesh(model.meshes[0], materials[0], rotateXYZ(rotationAngles))
