...
// include: C:\Users\jcarl\AppData\Local\Temp\tmpga0o6wbi.js
...
Module['FS_createPath']("/resources/shaders", "300es", true, true);
    ...
    loadPackage({"files": [{"filename": "/modelShader.fs", "start": 0, "end": 1838}, {"filename": "/modelShader.vs", "start": 1838, "end": 5755}, {"filename": "/resources/images/all_probes/stpeters_cross.png", "start": 5755, "end": 977843}, {"filename": "/resources/shaders/300es/modelShader.fs", "start": 977843, "end": 979681}, {"filename": "/resources/shaders/300es/modelShader.vs", "start": 979681, "end": 983598}, {"filename": "/resources/shaders/300es/skyboxShader.fs", "start": 983598, "end": 983866}, {"filename": "/resources/shaders/300es/skyboxShader.vs", "start": 983866, "end": 984347}, {"filename": "/skyboxShader.fs", "start": 984347, "end": 984615}, {"filename": "/skyboxShader.vs", "start": 984615, "end": 985096}, {"filename": "/stpeters_cross.png", "start": 985096, "end": 1957184}], "remote_package_size": 1957184});

  })();

// end include: C:\Users\jcarl\AppData\Local\Temp\tmpga0o6wbi.js
// include: C:\Users\jcarl\AppData\Local\Temp\tmpzpetpfo0.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\jcarl\AppData\Local\Temp\tmpzpetpfo0.js
// include: C:\Users\jcarl\AppData\Local\Temp\tmpzluiey9_.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\jcarl\AppData\Local\Temp\tmpzluiey9_.js
...
var ASM_CONSTS = {
  106184: () => { if (document.fullscreenElement) return 1; },  
 106230: () => { return document.getElementById('canvas').width; },  
 106282: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106350: () => { document.exitFullscreen(); },  
 106377: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106450: () => { if (document.fullscreenElement) return 1; },  
 106496: () => { return document.getElementById('canvas').width; },  
 106548: () => { return screen.width; },  
 106573: () => { document.exitFullscreen(); },  
 106600: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 106733: () => { return window.innerWidth; },  
 106759: () => { return window.innerHeight; },  
 106786: () => { if (document.fullscreenElement) return 1; },  
 106832: () => { return document.getElementById('canvas').width; },  
 106884: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106952: () => { if (document.fullscreenElement) return 1; },  
 106998: () => { return document.getElementById('canvas').width; },  
 107050: () => { return screen.width; },  
 107075: () => { return window.innerWidth; },  
 107101: () => { return window.innerHeight; },  
 107128: () => { if (document.fullscreenElement) return 1; },  
 107174: () => { return document.getElementById('canvas').width; },  
 107226: () => { return screen.width; },  
 107251: () => { document.exitFullscreen(); },  
 107278: () => { if (document.fullscreenElement) return 1; },  
 107324: () => { return document.getElementById('canvas').width; },  
 107376: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107444: () => { document.exitFullscreen(); },  
 107471: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 107529: () => { return screen.width; },  
 107554: () => { return screen.height; },  
 107580: () => { return window.screenX; },  
 107607: () => { return window.screenY; },  
 107634: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 107687: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 107758: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 107815: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108071: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108142: () => { if (document.fullscreenElement) return 1; },  
 108188: () => { return window.innerWidth; },  
 108214: () => { return window.innerHeight; },  
 108241: () => { if (document.pointerLockElement) return 1; }
};
