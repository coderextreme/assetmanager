...
const
  screenWidth = 960
  screenHeight = 540
  vertexSkyboxShader = "resources/shaders/300es/skyboxShader.vs"
  fragmentSkyboxShader = "resources/shaders/300es/skyboxShader.fs"

  vertexModelShader = "resources/shaders/300es/modelShader.vs"
  fragmentModelShader = "resources/shaders/300es/modelShader.fs"
...
proc animate(self: var Flower, camera: var Camera3D) =
  ...
  # drawSphere(self.translation, 0.04f, 64, 64, White)
  endShaderMode()
